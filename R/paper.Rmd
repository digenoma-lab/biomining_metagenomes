...
fig_1 <- wrap_plots(plot_mags_qc, plot_depth_sgbs_biom, plot_tree_s15_md,
                    design = "\nACCC\nBCCC", heights = c(0.85, 1)) +
  plot_annotation(tag_levels = list(c("a", "b", "c"))) &
  theme(plot.tag = element_text(size = 18, face = "bold"))
ggsave("article_profiling/fig_1.pdf", fig_1, height = 8, width = 15)
ggsave("article_profiling/fig_1.png", fig_1, height = 8, width = 15)

fig_2 <- wrap_plots(plot_depth_sgbs_both, plot_depth_spec_eco,
                    plot_depth_kggbs_biom, design = "\nAAABBCC\n") +
  plot_annotation(tag_levels = list(c("a", "", "b", "c"))) &
  theme(plot.tag = element_text(size = 18, face = "bold"))
...
snp_plot_nsgenes <- ggviolin(snp_nsgenes, x = "pathway", y = "wmis_cv", color = "pathway",
  ...
  stat_compare_means(comparisons = list(c("Sulfur", "Copper"), c("Sulfur", "Iron"),
                                        c("Copper", "Iron")), label = "p.format",
...
```{r fig4}
# Merge plots using patchwork
fig_4 <- wrap_plots(snp_plot_estim_bin, snp_plot_estim_phy, design = "AABB", heights = c(1, 0.9)) +
  plot_annotation(tag_levels = list(c("a", "b"))) &
  theme(plot.tag = element_text(size = 22, face = "bold"))
ggsave("article_profiling/fig_4.pdf", fig_4, height = 12, width = 15)
ggsave("article_profiling/fig_4.png", fig_4, height = 12, width = 15)

fig_5a <- wrap_plots(snp_plot_nsgenes, snp_plot_nsgensub, design = "AABB", heights = c(0.9, 1)) +
  plot_annotation(tag_levels = list(c("a", "b"))) &
  theme(plot.tag = element_text(size = 22, face = "bold"))
ggsave("article_profiling/fig_5a.pdf", fig_5a, height = 11, width = 19)
ggsave("article_profiling/fig_5a.png", fig_5a, height = 11, width = 19)

fig_5b <- wrap_plots(snp_plot_psgenes, snp_plot_kos, design = "AABBB", heights = c(0.9, 1)) +
  plot_annotation(tag_levels = list(c("c", "d"))) &
  theme(plot.tag = element_text(size = 22, face = "bold"))
ggsave("article_profiling/fig_5b.pdf", fig_5b, height = 12, width = 23)
ggsave("article_profiling/fig_5b.png", fig_5b, height = 12, width = 23)
